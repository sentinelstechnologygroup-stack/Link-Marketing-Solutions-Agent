...
// AI clients here (see firebaseClient/mcp/config.json `consent_path`) with an opaque
  ...
  useEffect(() => {
    (async () => {
      ...
      try {
        ...
        // Gate on the server's auth result, NOT firebaseClient.auth.isAuthenticated():
