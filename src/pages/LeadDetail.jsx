  ...
  const handleSaveCall = async () => {
    ...
    try {
      ...
      await firebaseClient.entities.Lead.update(lead.id, {
        ...
        conversationCompletedAt: ['connected', 'qualified', 'warm_transfer_completed', 'appointment_booked'].includes(disposition) ? now : lead.conversationCompletedAt || null,
        qualifiedAt: disposition === 'qualified' ? now : lead.qualifiedAt || null,
